...
const Channel = mongoose.model('ChannelData', ChannelSchema, 'voms');
//handle get request to /voms and /voms/{channelNumber}
/*
channelData
...
*/
router.get('/:channel', (req, res, next) => {   //return channelInfo of specific channel in voms, all videos
...
router.get('/', (req, res, next) => {   //return groupInfo/memberInfo for each channel in voms
    Group.findById('voms')
