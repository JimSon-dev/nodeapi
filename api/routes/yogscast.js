...
const Channel = mongoose.model('ChannelData', ChannelSchema, 'yogscast');

//handle get request to /yogscast and /yogscast/{channelNumber}
/*
channelData
...
*/
router.get('/:channel', (req, res, next) => {   //return channelInfo of specific channel in yogscast, all videos
...
router.get('/:channel/:page', (req, res, next) => {   //return channelInfo of specific channel in yogscast, all videos
    const id = req.params.channel;
...
router.get('/', (req, res, next) => {   //return groupInfo/memberInfo for each channel in yogscast
    Group.findById('yogscast')
