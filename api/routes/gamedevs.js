...
const Channel = mongoose.model('ChannelData', ChannelSchema, 'gamedevs');

//handle get request to /gamedevs and /gamedevs/{channelNumber}
/*
channelData
...
*/
router.get('/:channel', (req, res, next) => {   //return channelInfo of specific channel in gamedevs, all videos
...
router.get('/:channel/:page', (req, res, next) => {   //return channelInfo of specific channel in gamedevs, all videos
    const id = req.params.channel;
...
router.get('/', (req, res, next) => {   //return groupInfo/memberInfo for each channel in gamedevs
    Group.findById('gamedevs')
