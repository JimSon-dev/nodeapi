...
const Channel = mongoose.model('ChannelData', ChannelSchema, '774inc');

//handle get request to /774inc and /774inc/{channelNumber}
/*
channelData
...
*/
router.get('/:channel', (req, res, next) => {   //return channelInfo of specific channel in 774inc, all videos
...
router.get('/', (req, res, next) => {   //return groupInfo/memberInfo for each channel in 774inc
    Group.findById('774inc')
